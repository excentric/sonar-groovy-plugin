...
public class XmlReportParser {
    ...
    private void collectPackageMeasures(SMInputCursor packCursor) throws ParseException, XMLStreamException {
        while (packCursor.getNext() != null) {
            GroovyPackage pack = new GroovyPackage(packCursor.getAttrValue("name"));
    ...
    private void collectFileMeasures(SMInputCursor fileCursor, GroovyPackage pack) throws ParseException, XMLStreamException {
            ...
            if (fileCursor.asEvent().isStartElement()) {
                ...
                if (classKey != null) {
                    ...
                    if (canBeIncludedInFileMetrics(fileChildrenCursor)) {
                        ...
                        GroovyFile resource = new GroovyFile(pack.getKey(), classKey, false);
